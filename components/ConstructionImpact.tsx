...
const ConstructionImpact: React.FC = () => {
  return (
    <section className="bg-[#0f172a] py-32 px-4 relative overflow-hidden border-t border-white/5">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none">
         <div className="relative w-[1200px] h-[600px]">
            {/* Radar Scan Effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-500/10 to-transparent w-full h-full animate-[spin_10s_linear_infinite] origin-center opacity-30 blur-xl"></div>
            ...
            <svg viewBox="0 0 1000 500" className="w-full h-full fill-white/20">
                ...
                {/* Decorative lines */}
                <path d="M200 150 Q 350 50 500 200 T 800 150" fill="none" stroke="currentColor" strokeWidth="0.5" strokeDasharray="5,5" className="text-yellow-500/30" />
            </svg>
         </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Content */}
            <div>
                <span className="text-yellow-500 font-bold tracking-[0.2em] text-xs uppercase mb-4 block">Global Operations</span>
                <h2 className="text-5xl md:text-7xl font-bold text-white mb-8 font-[Manrope] leading-tight">
                    Scale That <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 animate-gradient">Delivers.</span>
                </h2>
                ...
                <button className="px-8 py-4 rounded-full border border-yellow-500/30 text-yellow-400 font-bold hover:bg-yellow-500 hover:text-black transition-all duration-300 shadow-[0_0_20px_rgba(234,179,8,0.1)] hover:shadow-[0_0_40px_rgba(234,179,8,0.4)]">
