...
const CreativeBlogPage: React.FC<Props> = ({
  onHomeClick,
  onPageChange,
  onVariantChange,
}) => {
    ...
    <div className="bg-[#050505] min-h-screen font-sans selection:bg-purple-500/30">
      ...
      <div className="pt-40 pb-20 px-6 max-w-[1400px] mx-auto">
        ...
        <p className="text-xl text-white/60 max-w-2xl font-mono">
          Exploring the boundaries of high-contrast digital brutalism and
          sensory interaction.
        </p>
      </div>
...
export default CreativeBlogPage;
